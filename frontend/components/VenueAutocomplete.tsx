          ...
          <div className="relative">
            ...
            {inputValue ? (
              <button
                type="button"
                onClick={handleClear}
                className="absolute right-2 top-1/2 -translate-y-1/2 text-tertiary hover:text-accent transition-colors"
              ...
              <svg
                className="absolute right-2 top-1/2 -translate-y-1/2 w-4 h-4 text-tertiary pointer-events-none"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <Popover.Portal>
          <Popover.Content
            className="
              ...
              bg-surface-card border border-default rounded-lg
          ...
          >
            {filteredSuggestions.length > 0 ? (
              ...
              <div className="py-3 px-4 text-sm text-tertiary">
